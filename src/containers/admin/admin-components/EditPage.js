...
const editPage = ({itemToEdit, onRouteChange, apiURL, deleteURL, editName}) => {
  ...
  return(
    <section className='container'>
      ...
      <button onClick={e => {axios.delete(deleteURL, itemToEdit).then(response => onRouteChange()).catch(error => console.log(error))}} type="button" className="btn btn-danger btn-lg btn-block">Delete</button>
    </section>
  )
}
